...
public class BankService 
{
	...
	public static Customer createAccounts(ArrayList<Service> allServiceList) {
		...
		System.out.println("Customer Can Create Following Accounts--\n");
		do {
	...
	private static Account createSavingsMaxAccount(ArrayList<Service> allServiceList) {
		...
		Account account = new Account("PRDSMA", "Savings Max Account", savingsServiceList,1000);
		return account;
	...
	private static Account createCurrentAccount(ArrayList<Service> allServiceList) {
		...
		Account account = new Account("PRDCA", "Current Account", currentServiceList, 1000);
		return account;
	}
	...
	private static Account createLoanAccount(ArrayList<Service> allServiceList) {
		...
		Account account = new Account("PRDLA", "Loan Account", loanServiceList, 1000);
		return account;

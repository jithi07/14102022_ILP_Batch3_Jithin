...
public class Service {
	...
	public static void displayProductDetails(Product productList[]) {
		...
		System.out.println("Product code " + "		" +"Product name " + "		" +"Product Description " + "		" +"Product price " + "		" +"Product Opendate " + "		" + "Product Validity" + "		" + "Product Expiry");
		for(Product product:productList)
		{
			if(product!=null)
		System.out.println(product.getProductCode() + "				" +product.getProductName() + "				" +product.getProductDescription() + "				" +product.getProductPrice() + "				" +product.getOpenDate() + "				" +product.getValidityDate() + "				" + product.getExpiryDate());
		}
	}
